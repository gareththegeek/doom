...
import { WadSideDef, WadSideDefsLump } from '../interfaces/WadSideDefsLump'
...
const readSideDef = (data: Buffer, offset: number): WadSideDef => ({
    ...
    sector: data.readInt16LE(offset + SideDefOffset.xoffset)
})

export const readSideDefsLump = (data: Buffer, entry: WadDirectoryEntry): WadSideDefsLump => {
