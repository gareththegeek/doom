...
const createTextureInternal = (
    ...
    gl.texImage2D(gl.TEXTURE_2D, level, internalFormat, width, height, 0, srcFormat, srcType, pixels as ArrayBufferView)
...
export const createTexture = (gl: WebGL2RenderingContext, pixels: WadColour[]): WebGLTexture => {
